...
echo "Применение миграции для переименования колонки context в description"
...
-- 2. Копируем данные, переименовывая колонку context в description
INSERT INTO words_new (id, word, translation, description, topic_id, difficulty, pronunciation, examples, created_at, updated_at)
SELECT id, word, translation, context, topic_id, difficulty, pronunciation, examples, created_at, updated_at FROM words;
